(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global["marked-diagrams"] = factory());
                  ...
                  if (isJump(c)) {
                      ...
                      if ((c === '>') && (pathSet.rightEndsAt(x, y) ||
                          ...
                          if (pathSet.downEndsAt(x, y + 0.5)) {
                              ...
                              // Only try this if all others failed
                              if (isPoint(grid(x, y + 1))) {
                                  dy = -0.25; // Back up if connecting to a point
                              }
